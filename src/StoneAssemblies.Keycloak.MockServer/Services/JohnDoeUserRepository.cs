namespace StoneAssemblies.Keycloak.MockServer.Services
{
    ...
    /// <summary>
    ///     The john doe user repository.
    /// </summary>
    public class JohnDoeUserRepository : IUserRepository
    {
        /// <summary>
        ///     The passwords.
        /// </summary>
        ...
        /// <summary>
        ///     Initializes static members of the <see cref="JohnDoeUserRepository" /> class.
        /// </summary>
        ...
        {
            Log.Information($"Validating credentials of user '{username}'");
